...
#             import pdb ; pdb.set_trace()
        ...
        fired, matched, index = single_muon(event.L1_muons,  7, 0.5,  8, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_7_eta0p5_Q8'  , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_7_eta0p5_Q8'  , int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons,  7, 0.5, 12, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_7_eta0p5_Q12' , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_7_eta0p5_Q12' , int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons,  7, 0.8,  8, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_7_eta0p8_Q8'  , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_7_eta0p8_Q8'  , int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons,  7, 0.8, 12, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_7_eta0p8_Q12' , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_7_eta0p8_Q12' , int(matched) * (index+1))
        ...
        fired, matched, index = single_muon(event.L1_muons, 10, 0.5,  8, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_10_eta0p5_Q8' , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_10_eta0p5_Q8' , int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons, 10, 0.5, 12, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_10_eta0p5_Q12', fired) ; self.fill(self.tree, 'matched_L1_SingleMu_10_eta0p5_Q12', int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons, 10, 0.8,  8, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_10_eta0p8_Q8' , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_10_eta0p8_Q8' , int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons, 10, 0.8, 12, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_10_eta0p8_Q12', fired) ; self.fill(self.tree, 'matched_L1_SingleMu_10_eta0p8_Q12', int(matched) * (index+1))
        ...
        fired, matched, index = single_muon(event.L1_muons, 15, 0.5,  8, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_15_eta0p5_Q8' , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_15_eta0p5_Q8' , int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons, 15, 0.5, 12, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_15_eta0p5_Q12', fired) ; self.fill(self.tree, 'matched_L1_SingleMu_15_eta0p5_Q12', int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons, 15, 0.8,  8, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_15_eta0p8_Q8' , fired) ; self.fill(self.tree, 'matched_L1_SingleMu_15_eta0p8_Q8' , int(matched) * (index+1))
        fired, matched, index = single_muon(event.L1_muons, 15, 0.8, 12, matches=event.gen_bmesons); self.fill(self.tree, 'L1_SingleMu_15_eta0p8_Q12', fired) ; self.fill(self.tree, 'matched_L1_SingleMu_15_eta0p8_Q12', int(matched) * (index+1))
