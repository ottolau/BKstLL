...
# WTau3Mu analysers
from CMGTools.BKstLL.analyzers.BKstJPsiEEAnalyzer        import BKstJPsiEEAnalyzer    
from CMGTools.BKstLL.analyzers.BKstJPsiTreeProducer      import BKstJPsiTreeProducer
...
mainAna = cfg.Analyzer(
    BKstJPsiEEAnalyzer,
    name = 'BKstJPsiEEAnalyzer',
)

treeProducer = cfg.Analyzer(
    BKstJPsiTreeProducer,
    name = 'BKstJPsiTreeProducer',
)
