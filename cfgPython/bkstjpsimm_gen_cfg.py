...
# WTau3Mu analysers
from CMGTools.BKstLL.analyzers.BKstJPsiMMGenAnalyzer            import BKstJPsiMMGenAnalyzer    
from CMGTools.BKstLL.analyzers.BKstJPsiMMGenTreeProducer        import BKstJPsiMMGenTreeProducer
...
inputdata = np.loadtxt('BdToKstJPsiMM_MINIAODSIM_filename.dat', dtype='str')
inputdata = ['root://cms-xrd-global.cern.ch/'+st for st in inputdata]

BKstJPsiMM = cfg.MCComponent(
    'BsJPsiMMPhi',
...
#    files = ['root://cms-xrd-global.cern.ch//store/user/tstreble/Bd_KstJPsi_mm_Pythia_GEN-SIM_18_07_01/BdToKstJPsimm_MINIAODSIM_18_07_09/180711_072019/0000/Bd_KstJPsi_mm_MINIAODSIM_99.root',
#            ],
...
mainAna = cfg.Analyzer(
    BKstJPsiMMGenAnalyzer,
    name = 'BKstJPsiMMGenAnalyzer',
    flavour = 13,
)

treeProducer = cfg.Analyzer(
    BKstJPsiMMGenTreeProducer,
    name = 'BKstJPsiMMGenTreeProducer',
)
