...
# WTau3Mu analysers
from CMGTools.BKstLL.analyzers.BKstJPsiEEGenAnalyzer        import BKstJPsiEEGenAnalyzer
from CMGTools.BKstLL.analyzers.BsJPsiPhiGenTreeProducer_AOD        import BsJPsiPhiGenTreeProducer_AOD
...
#    files = ['root://cms-xrd-global.cern.ch//store/mc/RunIIAutumn18DR/BsToPhi_ToMuMu_MuFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/AODSIM/PUPoissonAve20_102X_upgrade2018_realistic_v15-v2/110000/B8487657-8856-5A40-80D5-B173A1B991AF.root',]
    files = ['root://cms-xrd-global.cern.ch//store/user/klau/BKstPsiEEMuFilter/ttk_output_test.root',]
    #files = inputdata
...
mainAna = cfg.Analyzer(
    BKstJPsiEEGenAnalyzer,
    name = 'BKstJPsiEEGenAnalyzer',
    flavour = 11,
)

treeProducer = cfg.Analyzer(
    BsJPsiPhiGenTreeProducer_AOD,
    name = 'BsJPsiPhiGenTreeProducer_AOD',
)
